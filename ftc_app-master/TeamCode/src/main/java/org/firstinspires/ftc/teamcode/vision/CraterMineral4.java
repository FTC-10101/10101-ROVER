...
@Autonomous (name = "CraterMineral4")
//@Disabled
public class CraterMineral4 extends LinearOpMode{
        ...
        while(opModeIsActive()){
            ...
            switch (goldPosition){ // using for things in the autonomous program
                ...
                case UNKNOWN:
                    ...
                    telemetry.addLine("Had to do it to 'em (Shaggy used 5 percent of his power)");//Driver's Inclusion :)
                    telemetry.update();
                    sleep(250);
                    land();
                    ROVER.dump.setPosition(.5);
